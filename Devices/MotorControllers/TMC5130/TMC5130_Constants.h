...
#define TMC_WRITE_BIT (uint8_t)0x80
...
// Global configuration flags (Register TMC_GCONF 0x00)
#define TMC5130_GC_I_SCALE_ANALOG 	1
#define TMC5130_GC_INTERNAL_RSENSE	2
#define TMC5130_GC_EN_PWM_MODE		4
#define TMC5130_GC_SHAFT_INVERSION	16
