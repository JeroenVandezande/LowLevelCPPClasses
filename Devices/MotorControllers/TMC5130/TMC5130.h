...
namespace LowLevelEmbedded::Devices::MotorControllers
{
    ...
    public:
         ...
         */
        TMC5130& Configure_GeneralConfiguration(uint32_t clockFrequencyInHz, bool useAnalogCurrentReference,
         ...
         * @return Reference to the configured `TMC5130` instance for method chaining.
         */
        TMC5130& Configure_MotorConfiguration(float senseResistorValue, uint16_t fullStepsPerRotation,
                                              uint16_t idleCurrentInmA, uint16_t fullSpeedCurrentInmA,
                                              uint16_t rampupCurrentInmA, uint16_t rampDownCurrentInmA);
