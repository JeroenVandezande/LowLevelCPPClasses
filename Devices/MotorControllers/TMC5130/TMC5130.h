...
namespace LowLevelEmbedded::Devices::MotorControllers
{
    ...
    public:
         ...
         */
        TMC5130& Configure_GeneralConfiguration(unitsnet_cpp::Frequency clockFrequency, bool useAnalogCurrentReference,
                                                bool useInternalSenseResistors, bool enableStealthChopMode,
         ...
         * @return Reference to the configured `TMC5130` instance for method chaining.
         */
        TMC5130& Configure_MotorConfiguration(
            unitsnet_cpp::ElectricResistance senseResistor,
            uint16_t fullStepsPerRotation,
            unitsnet_cpp::ElectricCurrent idleCurrent,
            unitsnet_cpp::ElectricCurrent fullSpeedCurrent,
            unitsnet_cpp::ElectricCurrent rampupCurrent,
            unitsnet_cpp::ElectricCurrent rampDownCurrent);
       ...
       *
       */
        TMC5130& Configure_StealthChopThreshold(
       ...
       */
        TMC5130& Configure_CoolStepThreshold(
            unitsnet_cpp::RotationalSpeed speed);
       ...
       */
        TMC5130& SetHighVelocityThreshold(
            unitsnet_cpp::RotationalSpeed speed);
        ...
        int32_t LastKnownPosition;
        unitsnet_cpp::ElectricCurrent MotorIdleCurrent =
            unitsnet_cpp::ElectricCurrent::from_amperes(0.0f);
        unitsnet_cpp::ElectricCurrent MotorRampUpCurrent =
            unitsnet_cpp::ElectricCurrent::from_amperes(0.0f);
        unitsnet_cpp::ElectricCurrent MotorFullSpeedCurrent =
            unitsnet_cpp::ElectricCurrent::from_amperes(0.0f);
        unitsnet_cpp::ElectricResistance SenseResistor =
            unitsnet_cpp::ElectricResistance::from_ohms(0.0f);
         ...
         * of the periodic job.
         */
        void PeriodicJob(unitsnet_cpp::Duration elapsedTime);
         ...
         * movement.
         */
        void StartTimedConstantVelocity(
        ...
        void StartConstantVelocity(
            int32_t accelerationInPulsesPerSecondSquared,
            unitsnet_cpp::Frequency stepFrequency);
        ...
        void MoveToPosition(
            ...
            int32_t decelerationInPulsesPerSecondSquared);
    ...
    private:
        ...
        int32_t _readInt(uint8_t address) const;
        void _writeConfiguration();
        void _activateMoveCurrent();
        void _activateRampUpCurrent();
        bool _activate_current(unitsnet_cpp::ElectricCurrent current);
